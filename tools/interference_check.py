...
def derived() -> dict:
    ...
    power_piston_od = power_cyl_id - 2 * 0.4  # power_piston_radial_clearance in LTDEngine.scad
    displacer_crank_r = displacer_stroke / 2
    power_crank_r = POWER_STROKE / 2
    cold_plate_top_z = -AXLE_TO_DECK
    cold_plate_bottom_z = cold_plate_top_z - COLD_PLATE_T
    can_top_z = cold_plate_bottom_z + COLD_PLATE_DROP
    disp_can_top_z = can_top_z - DISP_AXIAL_CLEARANCE
